...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order Placed.create': { roles: ['business-owner'], key: 'order_placed', tenantPath: [], userPath: [] },
  'Payment Received.update': { roles: ['business-owner'], key: 'payment_received', tenantPath: [], userPath: [] },
  'Feedback Received.create': { roles: ['business-owner'], key: 'feedback_received', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['business-owner'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['business-owner', 'end-customer'];
